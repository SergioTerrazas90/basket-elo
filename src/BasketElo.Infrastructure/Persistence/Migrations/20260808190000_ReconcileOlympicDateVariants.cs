...
[Migration("20260808190000_ReconcileOlympicDateVariants")]
public partial class ReconcileOlympicDateVariants : Migration
{
        ...
        migrationBuilder.Sql("""
            WITH candidate_pairs AS (
                ...
                JOIN games f
                 ...
                 AND ABS(f."GameDateTimeUtc"::date - g."GameDateTimeUtc"::date) <= 1
