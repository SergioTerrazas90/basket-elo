...
public class BackfillCatalog : IBackfillCatalog
{
    ...
    [
        ...
        new("fiba", "Europe", "FIBA European Tier 2", "Europe: FIBA Europe League / EuroCup lineage", "2002-2003", EndSeason: "2007-2008", EloPoolKey: EloPoolKeys.EuropeClubs),
        ...
        new("wikipedia-uleb-cup", "Europe", "ULEB Cup", "Europe: ULEB Cup / EuroCup predecessor", "2002-2003", EndSeason: "2007-2008", EloPoolKey: EloPoolKeys.EuropeClubs),
        ...
        new("official-israel-basket", "Israel", "Super League", "Israel: BSL", "1953-1954", ExcludedSeasons: ["1955-1956", "1974-1975"], EndSeason: "2007-2008"),
        new("api-sports", "Israel", "Israel Cup", "Israel: Israel Cup", "2008-2009", CompetitionType: "domestic_cup", EndSeason: "2025-2026"),
        new("official-israel-basket", "Israel", "Israel Cup", "Israel: Israel Cup", "2006-2007", CompetitionType: "domestic_cup", ExplicitSeasons: ["2006-2007", "2007-2008"]),
        ...
        new(
            ...
            "Poland: Polish Cup",
            "2016",
            ProviderLeagues: [new("Poland", "Polish Cup", "end_year")],
        ...
        new("flashscore-domestic", "Denmark", "Basket Ligaen", "Denmark: Basket Ligaen", "2010-2011", EndSeason: "2025-2026"),
        new("flashscore-domestic", "Great Britain", "SLB", "Great Britain: SLB", "2010-2011", EndSeason: "2025-2026"),
        new("flashscore-domestic", "Norway", "BLNO", "Norway: BLNO", "2010-2011", EndSeason: "2025-2026"),
        ...
        new("global-sports-archive", "Asia", "FIBA Asia Cup", "Asia: FIBA Asia Cup", "1960", CompetitionType: "international", EloPoolKey: EloPoolKeys.NationalTeams, ExplicitSeasons: Years(1960, 1963, 1965, 1967, 1969, 1971, 1973, 1975, 1977, 1979, 1981, 1983, 1986, 1987, 1989, 1991, 1993, 1995, 1997, 1999, 2001, 2003, 2005, 2007, 2009, 2011, 2013, 2015, 2017, 2022, 2025), UsesSingleYearSeasonLabel: true),
        ...
        new("fiba", "Asia", "FIBA Asia Cup", "Asia: FIBA Asia Cup", "1960", CompetitionType: "international", EloPoolKey: EloPoolKeys.NationalTeams, ExplicitSeasons: Years(1960, 1963, 1965, 1967, 1969, 1971, 1973, 1975, 1977, 1979, 1981, 1983, 1986, 1987, 1989, 1991, 1993, 1995, 1997, 1999, 2001, 2003, 2005, 2007, 2009, 2011, 2013, 2015, 2017, 2022, 2025), UsesSingleYearSeasonLabel: true),
