...
The continuous historical catalog starts at 1992-1993 and ends at 2007-2008.
...
| Greek Cup | 1992-1993 through 2007-2008, except 2003-2004 | EOK official Cup archive | Only cataloged when that season also has ingested A1 games. The 2003-2004 page is excluded because it starts at game 15 and omits the first 14 games. |
...
The resulting historical production coverage is 3,156 A1 games across sixteen
seasons and 633 Cup games across fifteen editions. The three newly ingested
...
| Rank | Source | Seasons useful for this task | Assessment | Use |
| --- | --- | --- | --- | --- |
| 1 | [EOK official men's Cup archive](https://www.basket.gr/cup-men/kypello-andron-1992-1993/1746/) | Fifteen usable editions in the league-overlap window (posts 1746-1765, excluding 2003-2004) | Authoritative game-level pages exposed through the site's WordPress API, with dates, teams, scores, and page revision metadata. | Ingested provider |
